#import "../lib/template.typ": booktab
...
#booktab(
  ...
  [`bibcontent`],
  [`none`],
  [参考文献文件内容，需使用 `read()` 读取。示例：`bibcontent: read("ref.bib")`],
  [`bibstyle`],
  [`"numeric"`],
  ...
  [`override-bib`],
  [`false`],
  [是否自定义参考文献引用样式。设为 `true` 时忽略上述参数，用户需自行处理参考文献。模板仍会应用默认排版格式（五号字、悬挂缩进等），如需覆盖可添加自己的 `show bibliography` 规则],
) <config-bib>
